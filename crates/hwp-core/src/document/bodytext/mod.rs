...
pub use chart_data::{
    // Constants
    AxisId, AxisTickStyle, BrushStyle, ChartType, FillStyle, LocationType, Orientation, PenStyle,
    // Basic types
    Coor, Rect, VtColor,
    // Chart objects
    Axis, AxisGrid, AxisLabel, AxisScale, AxisTitle, Backdrop, Bar, Brush, ChartData, DataGrid,
    DataPoint, DataPointLabel, Doughnut, Fill, Footnote as ChartFootnote, Frame, Gradient, HiLo,
    Intersection, Legend, Light, LightSource, Location, Marker, Pen, PieObj, Plot, PlotBase,
    Position, PrintInformation, Series, SeriesLabel, SeriesMarker, Shadow, StatLine, TextLayout,
    Tick, Title as ChartTitle, ValueScale, View3D, VtChart, VtFont, Wall, Weighting,
};
...
pub enum ParagraphRecord {
    ...
    /// HWPX 이미지 참조 / HWPX image reference
    /// HWPX 형식에서 사용하는 간소화된 이미지 참조 구조
    /// Simplified image reference structure used in HWPX format
    HwpxImage {
