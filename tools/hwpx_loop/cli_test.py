...
class ProcessCliTest(unittest.TestCase):
    ...
    def make_runtime(self, root):
        ...
        runtime.write_text(
            ...
            "    print('removed')\n"
            "elif 'toolchain' in args and 'list' in args:\n"
            "    print('1.97.0\\nnightly-2025-06-01')\n"
            "elif 'which' in args and '--toolchain' in args:\n"
            "    print('/rustup-home/toolchains/nightly-2025-06-01-x86_64-unknown-linux-gnu/bin/rustc')\n"
            "elif '/tools/bin/cargo-fuzz' in args:\n"
            "    print('cargo-fuzz 0.13.1')\n"
            "elif 'rustc' in args and '+1.97.0' in args:\n"
            "    print('rustc 1.97.0\\nrelease: 1.97.0')\n"
            "elif 'rustc' in args and '+nightly-2025-06-01' in args:\n"
            ...
            "else:\n"
            "    sys.stdout.buffer.write(('ran ' + ' '.join(args)).encode())\n",
            encoding="utf-8",
        )
        runtime.chmod(0o755)
        return runtime
